...
class XBcontroller():
    ...
    def update(self) -> None:
        ...
        self.RSTICK = bool(self.joystick.get_button(9))
        self.LSTICK_X = self.joystick.get_axis(0)
        self.LSTICK_Y = self.joystick.get_axis(1)
        self.RSTICK_X = self.joystick.get_axis(2)
        self.RSTICK_Y = self.joystick.get_axis(3)
        self.LTRIG = self.joystick.get_axis(4)
        self.RTRIG = self.joystick.get_axis(5)
        
    # 
    def getInput(self, event:pygame.event.Event) -> str:
...
# this python file is meant to be imported so this code is for testing only
